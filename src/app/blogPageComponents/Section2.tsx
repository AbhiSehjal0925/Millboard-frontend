...
const Section2 = () => {
  ...
  const sectionStyle: React.CSSProperties = {
    ...
    color: 'white',
    overflow: 'hidden',
    padding: isMobile ? '48px 16px' : '80px 85px',
    background: '#efcfac',
    paddingBottom: '450px',
  };
  ...
  return (
    <section style={sectionStyle}>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="2000" height="451" viewBox="0 0 1440 451" fill="none" style={{
        ...
        <defs>
          <filter id="filter0_f_143_2" x="-440" y="0.359863" width="2320" height="431.64" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
