...
const Section2nd = () => {
    ...
    const section2imgStyle: React.CSSProperties = {
        background: `url(/images/section2stImg2.png) center / contain no-repeat`,
    ...
    const pngStyle: React.CSSProperties = {
        background: `url('/png/section2ndPng2.png') center / cover no-repeat`,
        width: '100%',
        height: '60%',
        position: 'absolute',
        bottom: '-200px',
    ...
    return (
        <section style={section2Style}>
            ...
            <div style={section2textStyle}>
                <div style={heading1Style}>Reasons to choose?</div>
                <div style={heading2Style}>Precision in every detail, power in every product</div>
                <div style={heading3Style}>Lorem ipsum dolor sit amet consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
            </div>
